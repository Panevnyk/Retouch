...
public class SUPasswordTextField: SUTextField {
    ...
    private func addRightArrow() {
        ...
        rightSecureButton.setImage(UIImage(named: "icEyeClosePurple", in: Bundle.module, compatibleWith: nil), for: .normal)
    ...
    public func setSecureTextEntry(_ isSecureTextEntry: Bool) {
        ...
        let eyeImg = UIImage(named: eyeImgString, in: Bundle.module, compatibleWith: nil)
