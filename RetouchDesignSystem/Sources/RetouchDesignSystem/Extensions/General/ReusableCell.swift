...
extension UITableView {
    ...
    public func registerNib<T: UITableViewCell>(cell: T.Type, bundle: Bundle) {
...
extension UICollectionView {
    ...
    public func register<T: UICollectionReusableView>(cell: T.Type, kind: String, bundle: Bundle) {
        register(cell.self, forSupplementaryViewOfKind: kind, withReuseIdentifier: cell.className)
    }
    
    public func registerNib<T: UICollectionViewCell>(cell: T.Type, bundle: Bundle) {
        register(UINib(nibName: cell.className, bundle: bundle),
                 forCellWithReuseIdentifier: cell.className)
    }

    public func registerNib<T: UICollectionReusableView>(cell: T.Type, kind: String, bundle: Bundle) {
