...
public final class NavigationItemFactory: NSObject {
    ...
    public class func createMenuItem(viewController: UIViewController, selector: Selector) -> UIBarButtonItem {
        return UIBarButtonItem(image: UIImage(named: "icMenu", in: Bundle.module, compatibleWith: nil), style: .done, target: viewController, action: selector)
    }

    public class func createAddItem(viewController: UIViewController, selector: Selector) -> UIBarButtonItem {
        return UIBarButtonItem(image: UIImage(named: "icAdd", in: Bundle.module, compatibleWith: nil)?.withRenderingMode(.alwaysOriginal),
                               style: .done,
    ...
    public class func createEditImgItem(viewController: UIViewController, selector: Selector) -> UIBarButtonItem {
        return UIBarButtonItem(image: UIImage(named: "icEdit", in: Bundle.module, compatibleWith: nil),
                               style: .done,
                               target: viewController,
                               action: selector)
    }
    ...
    public class func createBackItem(viewController: UIViewController, selector: Selector) -> UIBarButtonItem {
        return UIBarButtonItem(image: UIImage(named: "icArrowLeft", in: Bundle.module, compatibleWith: nil),
                               style: .done,
                               target: viewController,
                               action: selector)
    }
    ...
    public class func createLogOutItem(viewController: UIViewController, selector: Selector) -> UIBarButtonItem {
        return UIBarButtonItem(image: UIImage(named: "icExit", in: Bundle.module, compatibleWith: nil),
                               style: .done,
                               target: viewController,
                               action: selector)
    }
