...
extension RestApiError {
    ...
    /// Create RestApiError instance with Can not create URLRequest
    public static var canNotCreateURLRequest: Self {
        return Self(code: RestApiErrorCode.canNotCreateURLRequest, details: "Can not create URLRequest")
    }
}
